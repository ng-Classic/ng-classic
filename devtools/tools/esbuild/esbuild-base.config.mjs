      ...
      await createEsbuildAngularOptimizePlugin({
        ...
        enableLinker: enableLinker
          ? {
              ...
              linkerOptions: {
                // DevTools relies on Angular Classic framework packages that are consumed,
                // locally via bazel. These packages have a version of 0.0.0-PLACEHOLDER.
                // DevTools also relies on Angular Classic CDK and Material packages that are consumed via npm.
