 ...
 */
import {animate, AnimationMetadata, style} from '@ng-classic/animations';

import {AnimationStyleNormalizer, NoopAnimationStyleNormalizer} from '../../lib/dsl/style_normalization/animation_style_normalizer';
import {AnimationDriver} from '../../lib/render/animation_driver';
import {getBodyNode} from '../../lib/render/shared';
import {TimelineAnimationEngine} from '../../lib/render/timeline_animation_engine';
