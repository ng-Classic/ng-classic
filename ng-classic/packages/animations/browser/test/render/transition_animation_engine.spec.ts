 ...
 */
import {animate, AnimationEvent, AnimationMetadata, AnimationTriggerMetadata, NoopAnimationPlayer, state, style, transition, trigger} from '@ng-classic/animations';

import {TriggerAst} from '../../lib/dsl/animation_ast';
import {buildAnimationAst} from '../../lib/dsl/animation_ast_builder';
import {buildTrigger} from '../../lib/dsl/animation_trigger';
import {AnimationStyleNormalizer, NoopAnimationStyleNormalizer} from '../../lib/dsl/style_normalization/animation_style_normalizer';
import {getBodyNode} from '../../lib/render/shared';
import {TransitionAnimationEngine, TransitionAnimationPlayer} from '../../lib/render/transition_animation_engine';
import {MockAnimationDriver, MockAnimationPlayer} from '../../testing/lib/mock_animation_driver';
