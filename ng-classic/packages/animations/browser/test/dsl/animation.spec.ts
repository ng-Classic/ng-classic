 ...
 */
import {animate, animation, AnimationMetadata, AnimationMetadataType, AnimationOptions, AUTO_STYLE, group, keyframes, query, sequence, state, style, transition, trigger, useAnimation, ɵStyleDataMap} from '@ng-classic/animations';

import {Animation} from '../../lib/dsl/animation';
import {buildAnimationAst} from '../../lib/dsl/animation_ast_builder';
import {AnimationTimelineInstruction} from '../../lib/dsl/animation_timeline_instruction';
import {ElementInstructionMap} from '../../lib/dsl/element_instruction_map';
