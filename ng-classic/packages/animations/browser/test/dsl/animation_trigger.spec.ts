...
import {animate, AnimationOptions, state, style, transition} from '@ng-classic/animations';
import {AnimationTransitionInstruction} from '@ng-classic/animations/browser/lib/dsl/animation_transition_instruction';
import {AnimationTrigger} from '@ng-classic/animations/browser/lib/dsl/animation_trigger';

import {ENTER_CLASSNAME, LEAVE_CLASSNAME} from '../../lib/util';
