...
yarn_install(
    ...
    data = [
        ...
        "//tools/esm-interop:patches/npm/@angular-classic-tooling+0.0.0-8d4803573edc70b90a1134ffa996303d1dcc18a9.patch",
    ...
    # See https://github.com/ng-classic/dev-infra/pull/446#issuecomment-1059820287 for details.
