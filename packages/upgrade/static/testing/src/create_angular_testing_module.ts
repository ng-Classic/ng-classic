...
/**
 * A helper function to use when unit testing Angular Classic services that depend upon upgraded AngularJS
 * services.
 *
 ...
 * The `Ng2AppModule` is the Angular Classic part of our hybrid application and the `ng1AppModule` is the
 * AngularJS part.
 *
 ...
 *
 * In the following code snippet, `HeroesService` is an Angular Classic service that depends upon an
