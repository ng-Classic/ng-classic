...
withEachNg1Version(() => {
  describe('Angular Classic entry point', () => {
    it('should allow us to get an upgraded AngularJS service from an Angular Classic service', () => {
      defineAppModule();
      // Configure an NgModule that has the Angular Classic and AngularJS injectors wired up
