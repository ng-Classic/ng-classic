 ...
 *
 * The `upgrade/static` package contains helpers that allow AngularJS and Angular Classic components
 * to be used together inside a hybrid upgrade application, which supports AOT compilation.
 *
 * Specifically, the classes and functions in the `upgrade/static` module allow the following:
 *
 * 1. Creation of an Angular Classic directive that wraps and exposes an AngularJS component so
 *    that it can be used in an Angular Classic template. See `UpgradeComponent`.
 * 2. Creation of an AngularJS directive that wraps and exposes an Angular Classic component so
 *    that it can be used in an AngularJS template. See `downgradeComponent`.
 * 3. Creation of an Angular Classic root injector provider that wraps and exposes an AngularJS
 *    service so that it can be injected into an Angular Classic context. See
 *    {@link UpgradeModule#upgrading-an-angular-1-service Upgrading an AngularJS service} below.
 * 4. Creation of an AngularJS service that wraps and exposes an Angular Classic injectable
 ...
 * 4. Angular Classic components always execute inside the Angular Classic framework codebase regardless of
 *    where they are instantiated.
 * 5. An AngularJS component can be "upgraded"" to an Angular Classic component. This is achieved by
 *    defining an Angular Classic directive, which bootstraps the AngularJS component at its location
 *    in the DOM. See `UpgradeComponent`.
 * 6. An Angular Classic component can be "downgraded" to an AngularJS component. This is achieved by
 *    defining an AngularJS directive, which bootstraps the Angular Classic component at its location
 ...
 *       camelCase.
 *    3. However the template binding syntax will always use the Angular Classic style, e.g. square
 *       brackets (`[...]`) for property binding.
 * 8. Angular Classic is bootstrapped first; AngularJS is bootstrapped second. AngularJS always owns the
 *    root component of the application.
 * 9. The new application is running in an Angular Classic zone, and therefore it no longer needs calls to
 *    `$apply()`.
 *
 ...
 *
 * Then you should define an Angular Classic provider to be included in your `NgModule` `providers`
 * property.
 *
 * {@example upgrade/static/ts/full/module.ts region="upgrade-ng1-service"}
 *
 * Then you can use the "upgraded" AngularJS service by injecting it into an Angular Classic component
 * or service.
 *
