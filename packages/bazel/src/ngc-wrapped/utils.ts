...
export function patchNgHostWithFileNameToModuleName(
  ...
  function doFileNameToModuleName(importedFilePath: string, containingFilePath?: string): string {
    ...
    // metadata.json file that was published to npm in an Angular Classic library.
    ...
    // This is a workaround for https://github.com/ng-classic/ng-classic/issues/29454
    ...
    // break `esm2015` or `esm5` output for Angular Classic package release output
