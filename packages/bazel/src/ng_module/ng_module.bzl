...
def _expected_outs(ctx):
    ...
    if _should_produce_flat_module_outs(ctx):
        ...
        # in Ivy. Related discussion: https://github.com/ng-classic/ng-classic/pull/36971#issuecomment-625282383.
...
def _ngc_tsconfig(ctx, files, srcs, **kwargs):
    ...
    # https://github.com/ng-classic/ng-classic-cli/blob/3e8bdf72d6b7e2925d2822da807b726f88a77e1a/packages/angular_devkit/build_angular/src/babel/presets/application.ts#L199-L204
...
NG_MODULE_ATTRIBUTES = {
    ...
    # In the ng-classic/ng-classic Classicmonorepo, //tools:defaults.bzl wraps the ng_module rule in a macro
...
NG_MODULE_RULE_ATTRS = dict(dict(COMMON_ATTRIBUTES, **NG_MODULE_ATTRIBUTES), **{
    ...
    # https://github.com/ng-classic/ng-classic/blob/main/packages/compiler-cli/src/transformers/api.ts
