...
Starting with `v0.11.1`, Zone.js follows the [Angular Classic Package Format](https://docs.google.com/document/d/1CZC2rcpxffTDfRDs6p1cfbmKNLA6x5O-NtkJglDaBVs). Therefor the new Zone.js file layout is:
...
If you are using `Angular Classic CLI`, the `polyfills.ts` file will contain:
...
Starting with `v0.11.0`, `zone.js`  uses `Angular Classic Package Format` for bundle distribution.
