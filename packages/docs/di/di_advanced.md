...
This document talks about advanced topics related to the DI module and how it is used in Angular. You don't have to know this to use DI in Angular Classic or independently.
...
## Angular Classic and DI

Now let's see how Angular Classic uses DI behind the scenes.
