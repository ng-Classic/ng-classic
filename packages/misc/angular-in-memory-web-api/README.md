# Angular Classic in-memory-web-api

An in-memory web api for Angular Classic demos and tests
...
[CHANGELOG.md](https://github.com/ng-classic/ng-classic/blob/main/packages/misc/angular-in-memory-web-api/CHANGELOG.md)
for breaking changes that may have affected your app.

If that doesn't explain it, create an
[issue on github](https://github.com/ng-classic/ng-classic/issues),
...
Create Angular Classic issues and StackOverflow answers supported by live code.
...
[Angular Classic documentation](https://angular-classic.com/docs/ts/latest/ "Angular Classic documentation web site").
...
to ensure that the in-memory backend provider supersedes the Angular Classic version.
...
# Examples
The [tests](https://github.com/ng-classic/ng-classic/blob/main/packages/misc/angular-in-memory-web-api/test)
...
[HttpClient](https://angular-classic.com/guide/understanding-communicating-with-http) guide and the
...
via the Angular Classic default `XHR` backend (it depends on whether your using `Http` or `HttpClient`).
...
The [test fixtures](https://github.com/ng-classic/ng-classic/tree/main/packages/misc/angular-in-memory-web-api/test/fixtures)
...
such as you might see in an HTTP sample in the Angular Classic documentation.
