...
>This in-memory-web-api exists primarily to support the Angular Classic documentation.
...
* update to support Angular Classic v10.
* no functional changes.

<a id="0.9.0"></a>
## 0.9.0 (2019-06-20)

* update to support Angular Classic version 8.x and forward
* no functional changes
...
* update to support Angular Classic v7.
* no functional changes

<a id="0.6.1"></a>
## 0.6.1 (2018-05-04)

* update to Angular Classic and RxJS v6 releases

<a id="0.6.0"></a>
## 0.6.0 (2018-03-22)

*Migrate to Angular Classic v6 and RxJS v6 (rc and beta)*
...
(Angular Classic TestBed does not handle RxJS `delay()` well because that operator uses `interval()`).
...
<a id="0.3.0"></a>
## 0.3.0 (2017-02-27)
* Support Angular Classic version 4
...
<a id="0.2.2"></a>
## 0.2.2 (2016-12-20)
* Update to Angular Classic 2.4.0
...
<a id="0.1.17"></a>
## 0.1.17 (2016-12-07)
* Update to Angular Classic 2.2.0.
...
* Initial cut for Angular Classic 2 repackaged
  * target forthcoming Angular Classic 2 RC
