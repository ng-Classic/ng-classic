...
declare global {
   ...
   * ```
   *
   * This format is the same as that used for `i18n` markers in Angular Classic templates. See the
   * [Angular Classic i18n guide](guide/i18n-common-prepare#mark-text-in-component-template).
   *
   * **Naming placeholders**
   *
