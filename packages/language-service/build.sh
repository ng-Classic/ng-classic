...
# so that it can be consumed by the Angular Classic extension for local development.
...
EOT
_sedi 's#\# PLACE_HOLDER_FOR_ng-classic/ng-classic_packages/language-service/build.sh#"//.angular_packages/language-service:package.json", \# FOR TESTING ONLY! DO NOT COMMIT THIS LINE!#' WORKSPACE
