...
describe('language-service/compiler integration', () => {
  ...
  it('should show type-checking errors from components with poisoned scopes', () => {
    // Normally, the Angular Classic compiler suppresses errors from components that belong to NgModules
  ...
  it('should handle broken imports during incremental build steps', () => {
    ...
    // requests Angular Classic analysis in the presence of TypeScript-level errors. In the case of broken
    ...
    // module's import is broken. Angular Classic will correctly complain that the NgModule is declaring a
    ...
    // Angular Classic should be complaining about the module not being understandable.
    ...
    // Angular Classic should stop complaining about the NgModule.
