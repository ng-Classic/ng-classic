...
export interface InputDecorator {
   ...
   *
   * ```typescript
   * import { Component, Input, numberAttribute, booleanAttribute } from '@angular-classic/core';
   * @Component({
   *   selector: 'bank-account',
   *   template: `
   *     Bank Name: {{bankName}}
...
export interface HostBindingDecorator {
   ...
   * property and supplies configuration metadata. Angular Classic automatically checks host bindings during
