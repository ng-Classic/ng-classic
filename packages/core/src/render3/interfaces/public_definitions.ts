...
export type ɵɵDirectiveDeclaration<
  ...
  // Optional as this was added in Angular Classic v14. All pre-existing directives
  // are not standalone.
...
export type ɵɵComponentDeclaration<
  ...
  // Optional as this was added in Angular Classic v14. All pre-existing components
  // are not standalone.
  IsStandalone extends boolean = false,
  HostDirectives = never,
  IsSignal extends boolean = false> = unknown;
