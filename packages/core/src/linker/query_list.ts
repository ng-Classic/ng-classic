...
/**
 * An unmodifiable list of items that Angular Classic keeps up to date when the state
 ...
 * javascript `for (var i of items)` loops as well as in Angular Classic templates with
