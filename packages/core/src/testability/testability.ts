...
// Angular Classic internal, not intended for public API.
 ...
 * the browser.
 *
 * Angular Classic applications bootstrapped using an NgModule (via `@NgModule.bootstrap` field) will also
...
export class Testability implements PublicTestability {
   ...
   *
   * @param doneCb The callback to invoke when Angular Classic is stable or the timeout expires
   *    whichever comes first.
   * @param timeout Optional. The maximum time to wait for Angular Classic to become stable. If not
...
/**
 * Set the {@link GetTestability} implementation used by the Angular Classic testing framework.
 * @publicApi
 */
