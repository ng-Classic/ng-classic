...
import {bootstrapApplication, BrowserModule, platformBrowser} from '@angular-classic/platform-browser';
import {BrowserAnimationsModule, provideAnimations} from '@angular-classic/platform-browser/animations';
