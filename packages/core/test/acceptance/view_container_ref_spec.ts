...
describe('ViewContainerRef', () => {
  /**
   * Gets the inner HTML of the given element with all HTML comments and Angular Classic internal
  ...
  describe('lifecycle hooks', () => {
    // Angular Classic 5 reference: https://stackblitz.com/edit/lifecycle-hooks-vcref
    const log: string[] = [];
