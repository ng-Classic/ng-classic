...
import {PercentPipe} from '@angular-classic/common';
import {inject} from '@angular-classic/core';
import {ClassProvider, Component, Directive, Inject, Injectable, InjectFlags, InjectionToken, Injector, NgModule, NgModuleRef, ViewChild} from '@angular-classic/core/src/core';
import {NullInjector} from '@angular-classic/core/src/di/null_injector';
import {isClassProvider, isExistingProvider, isFactoryProvider, isTypeProvider, isValueProvider} from '@angular-classic/core/src/di/provider_collection';
import {EnvironmentInjector, R3Injector} from '@angular-classic/core/src/di/r3_injector';
import {setupFrameworkInjectorProfiler} from '@angular-classic/core/src/render3/debug/framework_injector_profiler';
import {getInjectorProfilerContext, InjectedService, InjectedServiceEvent, InjectorCreatedInstanceEvent, InjectorProfilerEvent, InjectorProfilerEventType, ProviderConfiguredEvent, ProviderRecord, setInjectorProfiler} from '@angular-classic/core/src/render3/debug/injector_profiler';
import {getNodeInjectorLView, NodeInjector} from '@angular-classic/core/src/render3/di';
import {getDependenciesFromInjectable, getInjectorProviders, getInjectorResolutionPath} from '@angular-classic/core/src/render3/util/injector_discovery_utils';
import {fakeAsync, tick} from '@angular-classic/core/testing';
import {TestBed} from '@angular-classic/core/testing/src/test_bed';
import {BrowserModule} from '@angular-classic/platform-browser';
import {Router, RouterModule, RouterOutlet} from '@angular-classic/router';
