  ...
  describe('schemas', () => {
    ...
    it('should log an error on unknown props and include a note on Web Components', () => {
      ...
      const lines = [
        ...
        `1. If 'may-be-web-component' is an Angular Classic component and it has the 'unknownProp' input, then verify that it is a part of an @NgModule where this component is declared.`,
      ...
      it(`should produce a warning when the '${directive}' directive ` +
         ...
         () => {
           ...
           const lines = [
             ...
             `If the '${directive}' is an Angular Classic control flow directive, please make sure ` +
                 `that either the '${
