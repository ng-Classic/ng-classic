 ...
 */
import {APP_INITIALIZER, ApplicationInitStatus} from '@angular-classic/core/src/application_init';
    ...
    it('should throw', () => {
      try {
        ...
        expect(e.message).toBe(
            ...
            '`multi: true` provider. Find more at https://angular-classic.com/errors/NG0209');
      }
    });
  });
});
