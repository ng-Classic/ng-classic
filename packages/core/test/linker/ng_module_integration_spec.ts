...
import {Compiler, Component, CUSTOM_ELEMENTS_SCHEMA, Directive, forwardRef, getModuleFactory, getNgModuleById, HostBinding, Inject, Injectable, InjectionToken, Injector, Input, NgModule, NgModuleRef, Optional, Pipe, Provider, Self, Type} from '@angular-classic/core';
import {ɵɵdefineInjectable} from '@angular-classic/core/src/di/interface/defs';
import {NgModuleType} from '@angular-classic/core/src/render3';
import {getNgModuleDef} from '@angular-classic/core/src/render3/definition';
import {ComponentFixture, inject} from '@angular-classic/core/testing';
