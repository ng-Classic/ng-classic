...
export function ngswAppInitializer(
  ...
  return () => {
    ...
    // Also, run outside the Angular Classic zone to avoid preventing the app from stabilizing (especially
 ...
 * @publicApi
 *
 * Sets up providers to register the given Angular Classic Service Worker script.
 *
