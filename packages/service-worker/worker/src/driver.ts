...
export class Driver implements Debuggable, UpdateSource {
  ...
  private onFetch(event: FetchEvent): void {
    ...
    // See https://github.com/ng-classic/ng-classic/issues/23012#issuecomment-376430187 for more details.
    ...
    // (See also https://github.com/ng-classic/ng-classic/issues/22362.)
