...
describe('Integration', () => {
  ...
  describe('navigation', function() {
    ...
    it('should not error if state is not {[key: string]: any}',
       fakeAsync(inject([Router, Location], (router: Router, location: SpyLocation) => {
         ...
         // Angular Classic does not support restoring state to the primitive.
  ...
  describe('navigation warning', () => {
    ...
    describe('with NgZone enabled', () => {
      it('should warn when triggered outside Angular Classic zone',
         fakeAsync(inject([Router], (router: Router) => {
           ...
           expect(warnings[0])
               .toBe(
                   `Navigation triggered outside Angular Classic zone, did you forget to call 'ngZone.run()'?`);
         })));

      it('should not warn when triggered inside Angular Classic zone',
         fakeAsync(inject([Router], (router: Router) => {
           router.navigateByUrl('/simple');
    ...
    describe('with NgZone disabled', () => {
      ...
      it('should not warn when triggered outside Angular Classic zone',
         fakeAsync(inject([Router], (router: Router) => {
           isInAngularZone = false;
           router.navigateByUrl('/simple');
  ...
  it('should properly set currentNavigation when cancelling in-flight navigations',
     fakeAsync(inject([Router], (router: Router) => {
       ...
       // Due to https://github.com/ng-classic/ng-classic/issues/29389, this would be `false`
  ...
  describe('guards', () => {
    ...
    describe('CanLoad', () => {
      ...
      // navigateByUrl promise: https://github.com/ng-classic/ng-classic/issues/26284
  ...
  describe('lazy loading', () => {
    ...
    // https://github.com/ng-classic/ng-classic/issues/12889
    ...
    // https://github.com/ng-classic/ng-classic/issues/13870
