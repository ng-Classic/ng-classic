...
function allTests(os: string) {
  describe('ngtsc behavioral tests', () => {
    ...
    describe('compiling invalid @Injectables', () => {
      describe('with strictInjectionParameters = true', () => {
        ...
        // https://github.com/ng-angular/angular/issues/48152
  ...
  `);
    ...
    // https://github.com/ng-angular/angular/issues/46936
  ...
  `);
    ...
    describe('inline resources', () => {
      ...
      it('large strings are wrapped in a function for Closure', () => {
        ...
        // large strings. See: https://github.com/ng-angular/angular/pull/38253.
        expect(jsContents)
            .toContain(
                '_c0 = function () {' +
