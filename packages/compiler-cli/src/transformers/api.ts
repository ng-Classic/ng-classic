...
export interface CompilerOptions extends NgCompilerOptions, ts.CompilerOptions {
  ...
  // Modify how Angular Classic annotations are emitted to improve tree-shaking.
   ...
   * in Angular Classic metadata (e.g. @Component, @Inject, @ViewChild). This can be enabled in
...
export interface Program {
   ...
   *
   * Angular Classic structural information is required to produce the program.
   */
   ...
   * collect Angular Classic structural information to produce the errors.
   */
  getTsOptionDiagnostics(cancellationToken?: ts.CancellationToken): ReadonlyArray<ts.Diagnostic>;

  /**
   * Retrieve options diagnostics for the Angular Classic options used to create the program.
   */
  getNgOptionDiagnostics(cancellationToken?: ts.CancellationToken): ReadonlyArray<ts.Diagnostic>;

  /**
   * Retrieve the syntax diagnostics from TypeScript. This is faster than calling
   * `getTsProgram().getSyntacticDiagnostics()` since it does not need to collect Angular Classic structural
  ...
  /**
   * Retrieve the diagnostics for the structure of an Angular Classic application is correctly formed.
   * This includes validating Angular Classic annotations and the syntax of referenced and imbedded HTML
   * and CSS.
   *
   ...
   *
   * Angular Classic structural information is required to produce these diagnostics.
   */
  ...
  /**
   * Retrieve the Angular Classic semantic diagnostics.
   *
   * Angular Classic structural information is required to produce these diagnostics.
   */
  ...
  /**
   * Load Angular Classic structural information asynchronously. If this method is not called then the
   * Angular Classic structural information, including referenced HTML and CSS files, are loaded
   * synchronously. If the supplied Angular Classic compiler host returns a promise from `loadResource()`
   ...
   *
   * Angular Classic structural information is required to emit files.
   */
