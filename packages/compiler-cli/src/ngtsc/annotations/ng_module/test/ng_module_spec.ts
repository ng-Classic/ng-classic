 ...
 */
import {R3NgModuleMetadataGlobal, WrappedNodeExpr} from '@angular-classic/compiler';
...
function detectNgModule(
    module: ClassDeclaration, handler: NgModuleDecoratorHandler,
        ...
        const {program} = makeProgram(
            [
              ...
              },
              {
                name: _('/entry.ts'),
                contents: `
                  import {NgModule, CUSTOM_ELEMENTS_SCHEMA} from '@angular-classic/core';
                  import {SomeComponent} from './some_where';
