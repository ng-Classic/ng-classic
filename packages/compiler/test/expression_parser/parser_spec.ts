...
import {AbsoluteSourceSpan, ASTWithSource, BindingPipe, Call, EmptyExpr, Interpolation, ParserError, PropertyRead, TemplateBinding, VariableBinding} from '@angular-classic/compiler/src/expression_parser/ast';
