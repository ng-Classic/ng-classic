 ...
 *   // Placeholder values, set to magic strings which get replaced by the Angular Classic runtime.
 *   {
 *     'interpolation': '\uFFFD0\uFFFD',
 *     'startTagSpan': '\uFFFD1\uFFFD',
 *     'interpolation_1': '\uFFFD2\uFFFD',
 ...
 *   // Options bag.
 *   {
 *     // Maps each placeholder to the original Angular Classic source code which generates it's value.
 *     original_code: {
...
export function createGoogleGetMsgStatements(
  ...
  if (Object.keys(placeholderValues).length) {
    // Message template parameters containing the magic strings replaced by the Angular Classic runtime with
