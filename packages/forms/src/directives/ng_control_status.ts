...
import {Directive, Optional, Self} from '@angular-classic/core';
...
/**
 * @description
 * Directive automatically applied to Angular Classic form controls that sets CSS classes
...
/**
 * @description
 * Directive automatically applied to Angular Classic form groups that sets CSS classes
