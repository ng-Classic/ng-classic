 ...
 *
 * Angular Classic uses object identity to select option. It's possible for the identities of items
 ...
 * If `compareWith` is given, Angular Classic selects option by the return value of the function.
 *
 * ```ts
