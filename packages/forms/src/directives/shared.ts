...
import {Inject, InjectionToken, ɵRuntimeError as RuntimeError} from '@angular-classic/core';
...
export function cleanUpControl(
  ...
  // `selectValueAccessor`. See https://github.com/ng-classic/ng-classic/issues/40521.
...
// TODO: vsavkin remove it once https://github.com/ng-classic/ng-classic/issues/3011 is implemented
