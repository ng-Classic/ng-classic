...
import {Directive, ElementRef, InjectionToken, Renderer2} from '@angular-classic/core';

/**
 * @description
 * Defines an interface that acts as a bridge between the Angular Classic forms API and a
