...
export class HammerGestureConfig {
   ...
   * Angular Classic supports all built-in recognizers, as listed in
 ...
 *
 * Import this module at the root of your application so that Angular Classic can work with
