...
class DefaultDomRenderer2 implements Renderer2 {
  ...
  createElement(name: string, namespace?: string): any {
    if (namespace) {
      ...
      // https://github.com/ng-classic/ng-classic/commit/2b9cc8503d48173492c29f5a271b61126104fbdb to
      // support how Ivy passed around the namespace URI rather than short name at the time. It did
      // not, however extend the support to other parts of the system (setAttribute, setAttribute,
      // and the ServerRenderer). We should decide what exactly the semantics for dealing with
      // namespaces should be and make it consistent.
      // Related issues:
      // https://github.com/ng-classic/ng-classic/issues/44028
      // https://github.com/ng-classic/ng-classic/issues/44883
  ...
  private decoratePreventDefault(eventHandler: Function): Function {
    ...
    // decoratePreventDefault or is a listener added outside the Angular Classic context so it can handle
