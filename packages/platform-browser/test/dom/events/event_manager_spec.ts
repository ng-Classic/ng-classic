...
import {DomEventsPlugin} from '@angular-classic/platform-browser/src/dom/events/dom_events';
import {EventManager, EventManagerPlugin} from '@angular-classic/platform-browser/src/dom/events/event_manager';
...
describe('EventManager', () => {
  ...
  it('should be able to remove event listener which was added inside of ngZone', () => {
    ...
    // one is Angular Classic zone, the other is not
  ...
  it('should run unpatchedEvents handler outside of ngZone', () => {
    ...
    // Register the event listener in the Angular Classic zone. If the handler would be
...
class FakeEventManagerPlugin extends EventManagerPlugin {
  ...
  constructor(doc: Document, public supportedEvents: string[]) {
    super(doc);
  }
