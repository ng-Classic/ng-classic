...
should mark the PR with the `action: merge` label and the correct [target label](https://github.com/ng-classic/angular/blob/main/docs/TRIAGE_AND_LABELS.md#pr-target).
