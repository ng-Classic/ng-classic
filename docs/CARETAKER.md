...
- Draining the queue of PRs ready to be merged. (PRs with [`action: merge`](https://github.com/ng-classic/ng-classic/pulls?q=is%3Aopen+is%3Apr+label%3A%22action%3A+merge%22) label)
- Assigning [new issues](https://github.com/ng-classic/ng-classic/issues?q=is%3Aopen+is%3Aissue+no%3Alabel) to individual component authors.
