## API Report File for "@angular-classic/platform-server"
...
import * as i1 from '@angular-classic/common/http';
import * as i2 from '@angular-classic/platform-browser/animations';
import * as i3 from '@angular-classic/platform-browser';
