import {DOCUMENT, Location, PlatformLocation, PopStateEvent, ViewportScroller} from '@angular-classic/common';
import {Inject, Injectable, OnDestroy} from '@angular-classic/core';
