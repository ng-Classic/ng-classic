...
describe('AppComponent', () => {
  ...
  describe('with proper DocViewer', () => {
    ...
    describe('deployment banner', () => {
      it('should show a message if the deployment mode is "archive"', async () => {
        ...
        expect(banner.textContent).toContain('archived documentation for Angular Classic v4');
      });
  ...
  describe('with mocked DocViewer', () => {
    ...
    describe('initial rendering', () => {
      ...
      it('should initially disable Angular Classic animations until a document is rendered', () => {
        initializeTest(false);
  ...
  navJson = {
    ...
    SideNav: [
      ...
      },
      {
        url: 'api',
        title: 'API',
        tooltip: 'Details of the Angular Classic classes and values.',
      },
    ],
