...
1.  In `product-details.component.ts`, import `ActivatedRoute` from `@angular-classic/router`, import `OnInit` from `@angular-classic/core`, and the `products` array from `../products`.
