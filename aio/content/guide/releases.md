...
For details, see [Supported Public API Surface of Angular](https://github.com/ng-angular/angular/blob/main/docs/PUBLIC_API.md "Supported Public API Surface of Angular").
