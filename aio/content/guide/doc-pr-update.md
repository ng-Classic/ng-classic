...
After it's approved, the changes are merged into `ng-angular/angular` and they become part of the Angular Classicdocumentation.
...
1.  After you update the working branch on your `origin` server, the fork of the `ng-angular/angular` repo in your GitHub account, your pull request updates automatically.
...
After you address all the feedback and your pull request has been approved, it is merged into `ng-angular/angular`.
The changes in your pull request should appear in the documentation shortly afterwards.

After your pull request is merged into `ng-angular/angular`, you can [clean up your workspace](guide/doc-edit-finish).
