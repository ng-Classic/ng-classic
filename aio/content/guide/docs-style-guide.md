...
If you have an idea that would result in navigation changes, [file an issue](https://github.com/ng-classic/ng-classic/issues/new/choose) first so that the Angular Classicteam and community can discuss the change.
...
If you have any questions that this style guide doesn't answer or you would like to discuss documentation styles, see the [Angular Classicrepo](https://github.com/ng-classic/ng-classic) and [file a documentation issue](https://github.com/ng-classic/ng-classic/issues/new/choose).
