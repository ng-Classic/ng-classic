...
*   For more in-depth information on the implementation, see the [Angular ClassicLanguage Service API](https://github.com/ng-classic/ng-classic/blob/main/packages/language-service/src/types.ts)
