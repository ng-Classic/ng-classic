...
| `app/app.module.ts` | Defines the root module, named `AppModule`, that tells Angular Classic how to assemble the application. Initially declares only the `AppComponent`. As you add more components to the app, they must be declared here.<br><br>_Only generated when using the `--standalone` option._ |
