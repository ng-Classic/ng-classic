...
| Area                                | API or Feature                                                                                             | Deprecated in | May be removed in |
|:---                                 |:---                                                                                                        |:---           |:---               |
| `@angular-classic/core` | `PACKAGE_ROOT_URL` | v17 | v19 |
...
Support for using the `ngModel` input property and `ngModelChange` event with reactive form directives has been deprecated in Angular Classic v6 and can be removed in a future version of Angular.
...
Angular Classic support for Microsoft's Internet Explorer 11 \(IE11\) is deprecated and will be removed in Angular Classic v13.
Ending IE11 support allows Angular Classic to take advantage of web platform APIs present only in evergreen browsers, resulting in better APIs for developers and more capabilities for application users.
...
**NOTE**: <br />
IE11 will be supported in Angular Classic v12 LTS releases through November 2022.
