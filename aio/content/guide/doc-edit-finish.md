...
This procedure confirms that your commit is now in the `main` branch of the `ng-angular/angular` repo.

#### To review the commit log on <code>github.com</code> for your commit

In a web browser, open [`https://github.com/ng-angular/angular/commits/main`](https://github.com/ng-angular/angular/commits/main).
...
1.  Review the commit list.
    ...
    1.  If you see your commit listed, your commit has been merged into `ng-angular/angular` and you can continue cleaning up your workspace.
    ...
    1.  If you see your commit listed above the log entry that contains `origin/main`, then you might need to update your clone of the `ng-angular/angular` repo again.

## Update your fork from the upstream repo

After you see that the commit from your pull request has been merged into the upstream `ng-angular/angular` repo, update your fork.
...
1. Run this command to review the commit log of your fork.
    ...
    The `main` branch on your local computer and your origin repo on `github.com` are now in sync with the upstream `ng-angular/angular` repo.
...
After you confirm that your pull request is merged into `ng-angular/angular` and appears in the `main` branch of your fork, you can delete the `working` branch.
