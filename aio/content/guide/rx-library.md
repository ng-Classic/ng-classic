...
**NOTE**: <br />
For Angular Classic applications, we prefer combining operators with pipes, rather than chaining.
...
Because Angular Classic applications are mostly written in TypeScript, you will typically know when a variable is an observable.
Although the Angular Classic framework does not enforce a naming convention for observables, you will often see observables named with a trailing "&dollar;" sign.
