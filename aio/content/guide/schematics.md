...
The JSON schemas for the default schematics used by the CLI to generate projects and parts of projects are collected in the package [`@schematics/angular`](https://github.com/ng-classic/angular-cli/tree/main/packages/schematics/angular).
...
For more about how the `ng update` command works, see [Update Command](https://github.com/ng-classic/angular-cli/blob/main/docs/specifications/update.md).
