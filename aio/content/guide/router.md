...
This topic describes how to implement many of the common tasks associated with adding the Angular Classic router to your application.

<a id="basics"></a>

## Generate an application with routing enabled

The following command uses the Angular Classic CLI to generate a basic Angular Classic application with an application routing module, called `AppRoutingModule`, which is an NgModule where you can configure your routes.
...
To use the Angular Classic router, an application needs to have at least two components so that it can navigate from one to the other.
...
This guide works with a CLI-generated Angular Classic application.
...
The Angular Classic CLI performs this step for you.
...
1.  Import `RouterModule` and `Routes` into your routing module.
    ...
    The Angular Classic CLI performs this step automatically.
...
1.  Define your routes in your `Routes` array.
    ...
    The second property, `component`, defines the component Angular Classic should use for the corresponding path.
...
1.  Add your routes to your application.
    ...
    This element informs Angular Classic to update the application view with the component for the selected route.
...
The Angular Classic router selects this route any time the requested URL doesn't match any router paths.
...
The two asterisks, `**`, indicate to Angular Classic that this `routes` definition is a wildcard route.
...
You can configure your routes to lazy load modules, which means that Angular Classic only loads modules as needed, rather than loading all modules when the application launches.
...
Almost all Angular Classic projects should use the default HTML5 style.
...
1.  Use root URLs \(URLs with an `authority`\) for all web resources: CSS, images, scripts, and template HTML files.
    ...
    *   If a link in the page is a root URL \(has an `authority`\), the `<base href>` is not used.
        In this way, an `APP_BASE_HREF` with an authority will cause all links created by Angular Classic to ignore the `<base href>` value.
