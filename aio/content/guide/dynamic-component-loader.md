...
Angular Classic comes with its own API for loading components dynamically.

<a id="directive"></a>

## The anchor directive

Before adding components, you have to define an anchor point to tell Angular Classic where to insert components.
...
Now Angular Classic knows where to dynamically load components.
...
Because it's referring to `adHost`, and `adHost` is the directive you set up earlier to tell Angular Classic where to insert dynamic components.
