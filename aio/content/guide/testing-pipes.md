...
You can test [pipes](guide/pipes) without the Angular Classic testing utilities.
...
Most pipes have no dependence on Angular Classic other than the `@Pipe` metadata and an interface.
