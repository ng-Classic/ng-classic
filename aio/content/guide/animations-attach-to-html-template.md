...
Bind the trigger to a template expression using standard Angular Classic property binding syntax. The `triggerName` is the name of the trigger, and `expression` evaluates to a defined animation state.
