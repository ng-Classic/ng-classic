...
Angular Classic binding distinguishes between HTML attributes and DOM properties.
...
Angular Classic provides three categories of data binding according to the direction of data flow:
