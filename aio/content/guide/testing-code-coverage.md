...
The Angular Classic CLI can run unit tests and create code coverage reports.
...
If you want to create code-coverage reports every time you test, set the following option in the Angular Classic CLI configuration file, `angular.json`:
...
If your team decides on a set minimum amount to be unit tested, enforce this minimum with the Angular Classic CLI.
