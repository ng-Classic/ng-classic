...
Angular Classic has two injector hierarchies:
...
The requests keep forwarding up until Angular Classic finds an injector that can handle the request or runs out of ancestor `ElementInjector` hierarchies.
