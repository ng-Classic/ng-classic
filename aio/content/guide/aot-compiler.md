...
Angular's [schema.ts](https://github.com/ng-angular/angular/blob/main/packages/compiler-cli/src/metadata/schema.ts) describes the JSON format as a collection of TypeScript interfaces.
...
Review the [source code](https://github.com/ng-angular/angular/blob/main/packages/router/src/router_module.ts#L139 "RouterModule.forRoot source code")
