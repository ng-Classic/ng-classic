...
The JSON schemas for the default schematics used by the Angular ClassicCLI to create projects and parts of projects are collected in the package [`@schematics/angular`](https://github.com/ng-classic/ng-classic-cli/blob/main/packages/schematics/angular/application/schema.json).
