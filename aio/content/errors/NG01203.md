...
1. Are you using **Nx and Module Federation** with Webpack? Your `webpack.config.js` may require [extra configuration](https://github.com/ng-angular/angular/issues/43821#issuecomment-1054845431) to ensure the forms package is shared.
