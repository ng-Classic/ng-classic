...
This tutorial lesson demonstrates how to add interpolation to Angular Classic templates in order to display dynamic data in a template.
...
The [Angular Classic template syntax](guide/template-syntax) supports mixing static template content with dynamic values and expressions.

Using the `{{ expression }}` in Angular Classic templates, you can render values from properties, `Inputs` and valid JavaScript expressions.
...
## Lesson review
In this lesson, you added a new HTML structure and used Angular Classic template syntax to render values in the `HousingLocation` template. Now, you have two important skills:
