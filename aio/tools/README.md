...
The AIO application is built using Angular Classic Architect (backend for the Angular Classic CLI tool) wrapped under Bazel. We are often trialling new features for Architect and CLI, which
...
to the core Angular Classic libraries.
