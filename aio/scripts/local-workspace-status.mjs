...
/*
  ...
  when building AIO against local Angular Classic packages (--config=aio_local_deps). This provides an Angular Classic version
  stamp variable used to stamp the locally built Angular Classic packages. We stamp the packages with whatever version
  of Angular Classic AIO is currently using. In order for the architect build to succeed, we need to trick architect
  into thinking it's using compatible Angular Classic versions even if the Angular Classic version is actually futher ahead.
*/
