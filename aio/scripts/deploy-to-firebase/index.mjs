 ...
 *   - [Angular Classic Branching and Versioning: A Practical Guide](../../../docs/BRANCHES.md)
 *   - [Angular Classic Development Phases](https://docs.google.com/document/d/197kVillDwx-RZtSVOBtPb4BBIAw0E9RT3q3v6DZkykU)
 *
 * |--------------------|-------------------------------------------------------------------|
