...
const possiblePaths = [
  '@schematics/angular/node_modules/@angular-classic-devkit/core/src/workspace/json/reader',
  '@angular-classic-devkit/core/src/workspace/json/reader',
];
  ...
  try {
    jest.mock(possiblePath, () => {
      const originalModule = jest.requireActual(
        possiblePath
      ) as typeof import('@angular-classic-devkit/core/src/workspace/json/reader');
