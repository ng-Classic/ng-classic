...
/**
 * We use the NX_TSCONFIG_PATH environment variable when using the @angular-classic/nx-angular:webpack-browser
 * builder as it will generate a temporary tsconfig file which contains any required remappings of
 * shared libraries.
 * A remapping will occur when a library is buildable, as webpack needs to know the location of the
 * built files for the buildable library.
 * This NX_TSCONFIG_PATH environment variable is set by the @angular-classic/nx-angular:webpack-browser and it contains
