...
import {TypeScriptReflectionHost} from '../lib/ngtsc/reflection';
import {getDownlevelDecoratorsTransform} from '../lib/transformers/downlevel_decorators_transform/index';
...
describe('downlevel decorator transform', () => {
  ...
  it('should not downlevel non-Angular Classic class decorators', () => {
    const {output} = transform(`
  ...
  it('should not downlevel non-Angular Classic class decorators generated by a builder', () => {
    const {output} = transform(`
  ...
  // Angular Classic is not concerned with type information for decorated class members. Instead,
  ...
  it('should not capture constructor parameter types when not resolving to a value', () => {
    ...
    const {output} = transform(`
       import {Directive, Inject} from '@angular-classic/core';
       import * as Angular Classic from './external';
