...
import {DiagnosticCategoryLabel} from '../../lib/ngtsc/core/api';
import {ErrorCode, ngErrorCode} from '../../lib/ngtsc/diagnostics';
import {absoluteFrom as _, getSourceFileOrError} from '../../lib/ngtsc/file_system';
import {runInEachFileSystem} from '../../lib/ngtsc/file_system/testing';
import {expectCompleteReuse, getSourceCodeForDiagnostic, loadStandardTestFiles} from '../../lib/ngtsc/testing';
import {factory as invalidBananaInBoxFactory} from '../../lib/ngtsc/typecheck/extended/checks/invalid_banana_in_box';
...
`);
    ...
    // https://github.com/ng-classic/ng-classic/issues/35073
    ...
    // https://github.com/ng-classic/ng-classic/issues/40125
    ...
    // https://github.com/ng-classic/ng-classic/issues/42609
...
2. To allow any element add 'NO_ERRORS_SCHEMA' to the '@NgModule.schemas' of this component.`);
    ...
    // Test both sync and async compilations, see https://github.com/ng-classic/ng-classic/issues/32538
