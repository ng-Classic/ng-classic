...
import {mainXi18n} from '../../lib/extract_i18n';
import {main, mainDiagnosticsForTest, readNgcCommandLineAndConfiguration} from '../../lib/main';
import {absoluteFrom, AbsoluteFsPath, FileSystem, getFileSystem, relativeFrom} from '../../lib/ngtsc/file_system';
import {Folder, MockFileSystem} from '../../lib/ngtsc/file_system/testing';
import {IndexedComponent} from '../../lib/ngtsc/indexer';
import {NgtscProgram} from '../../lib/ngtsc/program';
import {DeclarationNode} from '../../lib/ngtsc/reflection';
import {NgtscTestCompilerHost} from '../../lib/ngtsc/testing';
import {TemplateTypeChecker} from '../../lib/ngtsc/typecheck/api';
import {setWrapHostForTest} from '../../lib/transformers/compiler_host';
