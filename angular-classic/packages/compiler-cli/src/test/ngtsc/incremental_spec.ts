...
runInEachFileSystem(() => {
  describe('ngtsc incremental compilation', () => {
    ...
    // https://github.com/ng-classic/ng-classic/issues/32416
    ...
    it('should compile incrementally with template type-checking turned on', () => {
      ...
      // https://github.com/ng-classic/ng-classic/issues/30079), this would have crashed.
    });

    // https://github.com/ng-classic/ng-classic/issues/38979
    ...
    // https://github.com/ng-classic/ng-classic/pull/26036
