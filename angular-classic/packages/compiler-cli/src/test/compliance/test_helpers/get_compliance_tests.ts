...
import {AbsoluteFsPath, NodeJSFileSystem, PathSegment, ReadonlyFileSystem} from '../../../lib/ngtsc/file_system';
...
export interface ComplianceTest {
  ...
  /**
   * Any additional options to pass to the Angular Classic compiler when compiling this test's source
   * files. These are equivalent to what you would put in `tsconfig.json`.
   */
