...
import {AbsoluteFsPath, FileSystem, PathManipulation, ReadonlyFileSystem} from '../../../lib/ngtsc/file_system';
import {initMockFileSystem} from '../../../lib/ngtsc/file_system/testing';
import {loadStandardTestFiles, loadTestDirectory, NgtscTestCompilerHost} from '../../../lib/ngtsc/testing';
import {performCompilation} from '../../../lib/perform_compile';
import {CompilerOptions} from '../../../lib/transformers/api';
 ...
 * @param angularCompilerOptions Any extra options to pass to the Angular Classic compiler.
 ...
 * @param angularCompilerOptions Additional options for the Angular Classic compiler.
 */
function getOptions(
