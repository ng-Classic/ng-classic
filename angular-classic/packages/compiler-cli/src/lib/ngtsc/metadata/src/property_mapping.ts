...
/**
 * The name by which an input or output of a directive or component is bound in an Angular Classic template.
 *
 * This type exists for documentation only.
 */
 ...
 * or directive class, as well as an Angular Classic template property name used for binding.
 */
export interface InputOrOutput {
  ...
  /**
   * The property name used to bind this input or output in an Angular Classic template.
   */
