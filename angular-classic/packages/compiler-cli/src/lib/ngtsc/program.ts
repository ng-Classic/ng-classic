...
/**
 * Entrypoint to the Angular Classic Compiler (Ivy+) which sits behind the `api.Program` interface, allowing
 * it to be a drop-in replacement for the legacy View Engine compiler to tooling such as the
 * command-line main() function or the Angular Classic CLI.
 */
export class NgtscProgram implements api.Program {
   ...
   *
   * This is used by the Angular Classic CLI to allow for spawning (async) child compilations for things
