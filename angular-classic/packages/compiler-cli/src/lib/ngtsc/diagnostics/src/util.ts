 ...
 * this, all Angular Classic error codes start with "-99" so that the sequence "TS-99" can be assumed to
 * correspond with an Angular Classic specific error code. This function replaces those occurrences with
 * just "NG".
 *
