 ...
 * represents the reusable Angular Classic part of its compilation.
 */
 ...
 * not be from an Angular Classic compilation (that is, it need not have been created from `NgCompiler`).
 *
 * If it is, though, Angular Classic can benefit from reusing previous analysis work. This reuse is managed
