...
import {PartialLinker} from '../../../lib/file_linker/partial_linkers/partial_linker';
import {LinkerRange, PartialLinkerSelector} from '../../../lib/file_linker/partial_linkers/partial_linker_selector';
    ...
    describe('[unknown declaration version]', () => {
      ...
      describe('[unknownDeclarationVersionHandling is "warn"]', () => {
        it('should use the most recent linker and log a warning', () => {
          ...
          expect(logger.logs.warn).toEqual([
            [`This application depends upon a library published using Angular Classic version 14.0.5, ` +
             `which requires Angular Classic version 13.1.0 or newer to work correctly.\n` +
