...
import {NodeJSFileSystem} from '../../../lib/ngtsc/file_system';
import {ConsoleLogger, LogLevel} from '../../../lib/ngtsc/logging';
 ...
 * way of integrating the Angular Classic Linker into a build pipeline other than the Angular Classic CLI.
 *
