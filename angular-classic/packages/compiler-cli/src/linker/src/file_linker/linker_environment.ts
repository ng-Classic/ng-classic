 ...
 */
import {ReadonlyFileSystem} from '../../../lib/ngtsc/file_system';
import {Logger} from '../../../lib/ngtsc/logging';
import {SourceFileLoader} from '../../../lib/ngtsc/sourcemaps';
import {AstFactory} from '../../../lib/ngtsc/translator';
