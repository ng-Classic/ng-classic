 ...
 */
import {compileNgModule, ConstantPool, outputAst as o, R3DeclareNgModuleMetadata, R3NgModuleMetadata, R3PartialDeclaration, R3Reference, R3SelectorScopeMode} from '@angular-classic/compiler';
