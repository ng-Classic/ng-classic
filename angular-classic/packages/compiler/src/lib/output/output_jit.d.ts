...
export declare class JitEvaluator {
     ...
     * @param statements An array of Angular Classic statement AST nodes to be evaluated.
...
/**
 * An Angular Classic AST visitor that converts AST nodes into executable JavaScript code.
 */
