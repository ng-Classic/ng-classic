 ...
 */
export type CreateOp = ListEndOp<CreateOp> | StatementOp<CreateOp> | ElementOp | ElementStartOp | ElementEndOp | ContainerOp | ContainerStartOp | ContainerEndOp | TemplateOp | TextOp | ListenerOp | PipeOp | VariableOp<CreateOp>;
/**
 ...
 */
export declare function createElementStartOp(tag: string, xref: XrefId): ElementStartOp;
/**
 ...
 * Create a `TemplateOp`.
 */
export declare function createTemplateOp(xref: XrefId, tag: string): TemplateOp;
/**
 ...
 */
export declare function createElementEndOp(xref: XrefId): ElementEndOp;
/**
 ...
 * Create a `TextOp`.
 */
export declare function createTextOp(xref: XrefId, initialValue: string): TextOp;
/**
