...
import * as e from '../../../lib/expression_parser/ast';
import {Lexer} from '../../../lib/expression_parser/lexer';
import {Parser} from '../../../lib/expression_parser/parser';
import * as html from '../../../lib/ml_parser/ast';
import {HtmlParser} from '../../../lib/ml_parser/html_parser';
import {WhitespaceVisitor} from '../../../lib/ml_parser/html_whitespaces';
import {DEFAULT_INTERPOLATION_CONFIG, InterpolationConfig} from '../../../lib/ml_parser/interpolation_config';
import {ParseTreeResult} from '../../../lib/ml_parser/parser';
import * as a from '../../../lib/render3/r3_ast';
import {htmlAstToRender3Ast, Render3ParseResult} from '../../../lib/render3/r3_template_transform';
import {I18nMetaVisitor} from '../../../lib/render3/view/i18n/meta';
import {LEADING_TRIVIA_CHARS} from '../../../lib/render3/view/template';
import {ElementSchemaRegistry} from '../../../lib/schema/element_schema_registry';
import {BindingParser} from '../../../lib/template_parser/binding_parser';
